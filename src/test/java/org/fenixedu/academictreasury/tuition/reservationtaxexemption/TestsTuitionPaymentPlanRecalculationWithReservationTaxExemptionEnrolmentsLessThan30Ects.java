...
public class TestsTuitionPaymentPlanRecalculationWithReservationTaxExemptionEnrolmentsLessThan30Ects {
    ...
    public void tuitionPaymentPlanWithReservationTaxExemption() {
        ...
        RegistrationTuitionService.startServiceInvocation(registration, executionYear, new LocalDate())
                .applyEnrolledEctsUnits(new BigDecimal("15")) //
                .applyEnrolledCoursesCount(new BigDecimal("5")) //
                .withInferedTuitionPaymentPlan() //
                .withAllInstallments() //
        ...
        assertEquals(new BigDecimal("250.00"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("350.00"), academicTreasuryEvent.getNetExemptedAmount());
        assertEquals(new BigDecimal("150.00"), academicTreasuryEvent.getNetExemptedAmount(firstInstallmentProduct).setScale(2));
        assertEquals(new BigDecimal("150.00"), academicTreasuryEvent.getNetExemptedAmount(secondInstallmentProduct).setScale(2));
        
        TreasuryExemptionType usedTreasuryExemptionType = TreasuryExemptionType.findByCode("TET1").findFirst().get();
