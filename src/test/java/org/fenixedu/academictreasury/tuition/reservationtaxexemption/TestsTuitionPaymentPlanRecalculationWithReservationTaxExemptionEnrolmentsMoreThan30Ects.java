...
public class TestsTuitionPaymentPlanRecalculationWithReservationTaxExemptionEnrolmentsMoreThan30Ects {
    ...
    public void tuitionPaymentPlanWithReservationTaxExemption() {
        ...
        assertEquals(new BigDecimal("1250.00"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("350.00"), academicTreasuryEvent.getNetExemptedAmount());
        assertEquals(new BigDecimal("350.00"), academicTreasuryEvent.getNetExemptedAmount(firstInstallmentProduct).setScale(2));
        assertEquals(new BigDecimal("0.00"), academicTreasuryEvent.getNetExemptedAmount(secondInstallmentProduct).setScale(2));
