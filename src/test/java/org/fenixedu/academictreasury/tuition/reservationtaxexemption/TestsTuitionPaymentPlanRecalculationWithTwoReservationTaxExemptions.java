...
public class TestsTuitionPaymentPlanRecalculationWithTwoReservationTaxExemptions {
    ...
    public void tuitionPaymentPlanWithReservationTaxExemption() {
        ...
        assertEquals(new BigDecimal("150.00"), academicTreasuryEvent.getNetExemptedAmount(secondInstallmentProduct));
