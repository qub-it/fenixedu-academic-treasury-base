...
public class TestsTuitionPaymentPlanRecalculationWithTwoReservationTaxExemptionsLessThan30Ects {
    ...
    public void tuitionPaymentPlanWithReservationTaxExemption() {
        ...
        assertEquals(new BigDecimal("350.00"), academicTreasuryEvent.getAmountWithVatToPay());
        ...
        assertEquals(new BigDecimal("200.00"), academicTreasuryEvent.getNetExemptedAmount(secondInstallmentProduct).setScale(2));
        assertEquals(new BigDecimal("50.00"), academicTreasuryEvent.getNetExemptedAmount(thirdInstallmentProduct).setScale(2));
        
        assertEquals(new BigDecimal("150.00"), academicTreasuryEvent.getAmountWithVatToPay(thirdInstallmentProduct));
        assertEquals(new BigDecimal("200.00"), academicTreasuryEvent.getAmountWithVatToPay(fourthInstallmentProduct));
