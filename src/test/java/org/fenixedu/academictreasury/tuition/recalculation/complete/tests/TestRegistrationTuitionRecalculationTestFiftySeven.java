 ...
 * Result:
 *
 * The first instalment is credited
 * The remaining three instalments are created
 *
 */

@RunWith(FenixFrameworkRunner.class)
public class TestRegistrationTuitionRecalculationTestFiftySeven {
    ...
    private static void createTuitionAllocationData() {
        ...
        TreasuryExemptionType exemptionType = TreasuryExemptionType.findByCode("TET5").findFirst().get();
    ...
    public void doRecalculation() {
        ...
        assertEquals(new BigDecimal("225.00"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("75.00"), academicTreasuryEvent.getNetExemptedAmount());
        ...
        // Remove the exemption and create with less one cent
        firstInstallment.getTreasuryExemptionsSet().iterator().next().revertExemption();

        assertEquals(new BigDecimal("300.00"), firstInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("0.00"), firstInstallment.getNetExemptedAmount());

        TreasuryExemption.create(firstAllocation.getTreasuryExemptionTypesSet().iterator().next(), "teste", new BigDecimal("74.99"),
                firstInstallment);

        assertEquals(new BigDecimal("225.01"), firstInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("74.99"), firstInstallment.getNetExemptedAmount());
        ...
        settlementNoteBean.getPaymentEntries()
                .add(new SettlementNoteBean.PaymentEntryBean(firstInstallment.getAmountWithVat(), PaymentMethod.findByCode("NU"),
                        null));
        ...
        assertEquals(new BigDecimal("225.00"), academicTreasuryEvent.getAmountWithVatToPay(firstInstallmentProduct));
        assertEquals(new BigDecimal("75.00"), academicTreasuryEvent.getNetExemptedAmount(firstInstallmentProduct));
        ...
        assertEquals(new BigDecimal("225.00"), secondFirstInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("75.00"), secondFirstInstallment.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("225.00"), secondInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("75.00"), secondInstallment.getNetExemptedAmount());

        assertEquals(new BigDecimal("900.00"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("300.00"), academicTreasuryEvent.getNetExemptedAmount());
