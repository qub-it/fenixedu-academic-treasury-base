 ...
 * Result:
 *
 * The first installment is credited
 * The remaining three instalments with exemption
 *
 */

@RunWith(FenixFrameworkRunner.class)
public class TestRegistrationTuitionRecalculationTestThirtyTwo {
    ...
    public void doRecalculation() {
        ...
        settlementNoteBean.getInvoiceEntryBean(firstInstallment).setSettledAmount(new BigDecimal("263.37"));
        ...
        settlementNoteBean.getPaymentEntries()
                .add(new SettlementNoteBean.PaymentEntryBean(new BigDecimal("263.37"), PaymentMethod.findByCode("NU"), null));
        ...
        assertEquals(new BigDecimal("158.02"), creditEntry.getAmountWithVat());
        assertEquals(new BigDecimal("21.98"), creditEntry.getNetExemptedAmount());
