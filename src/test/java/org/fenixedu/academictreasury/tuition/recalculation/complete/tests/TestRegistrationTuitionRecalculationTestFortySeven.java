...
public class TestRegistrationTuitionRecalculationTestFortySeven {
    ...
    public void doRecalculation() {
        ...
        DocumentNumberSeries debitDocNumSeries =
                DocumentNumberSeries.findUniqueDefaultSeries(FinantialDocumentType.findForDebitNote(),
                        firstInstallment.getFinantialEntity());
        DebitNote.createDebitNoteForDebitEntry(firstInstallment, null, debitDocNumSeries, new DateTime(), new LocalDate(), null,
                null, null).closeDocument();
        ...
        assertEquals(new BigDecimal("60.00"), creditEntry.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("71.40"), secondInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("168.60"), secondInstallment.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("210.70"), thirdInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("29.30"), thirdInstallment.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("210.70"), fourInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("29.30"), fourInstallment.getNetExemptedAmount());

        assertEquals(new BigDecimal("492.80"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("467.20"), academicTreasuryEvent.getNetExemptedAmount());
