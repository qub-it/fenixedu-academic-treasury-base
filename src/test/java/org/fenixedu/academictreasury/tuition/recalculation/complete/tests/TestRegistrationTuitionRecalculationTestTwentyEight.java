...
public class TestRegistrationTuitionRecalculationTestTwentyEight {
    ...
    public void doRecalculation() {
        ...
        CreditEntry firstInstallmentCreditEntry = firstInstallment.getCreditEntriesSet().iterator().next();
        assertEquals(new BigDecimal("40.00"), firstInstallmentCreditEntry.getAmountWithVat());
        assertEquals(new BigDecimal("230.00"), firstInstallmentCreditEntry.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("0.00"), DebitEntry.findActive(academicTreasuryEvent, firstInstallmentProduct)
                .map(DebitEntry::getAvailableAmountWithVatForCredit).reduce(BigDecimal.ZERO, BigDecimal::add));

        assertEquals(new BigDecimal("50.00"), DebitEntry.findActive(academicTreasuryEvent, firstInstallmentProduct)
        ...
        assertEquals(new BigDecimal("0.00"), fourthInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("50"), fourthInstallment.getNetExemptedAmount());
    }
