 ...
 * Result:
 *
 * The first installment is annuled and replaced
 * The remaining three instalments are created with exemption
 */

@RunWith(FenixFrameworkRunner.class)
public class TestRegistrationTuitionRecalculationTestFortySix {
    ...
    public void doRecalculation() {
        ...
        assertEquals(new BigDecimal("240.00"), secondFirstInstallment.getNetExemptedAmount());
