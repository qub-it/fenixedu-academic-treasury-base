...
public class TestRegistrationTuitionRecalculationTestThirtyFive {
    ...
    public void doRecalculation() {
        ...
        assertEquals(new BigDecimal("400.00"), academicTreasuryEvent.getNetExemptedAmount(firstInstallmentProduct));
        ...
        assertEquals(new BigDecimal("400.00"), secondFirstInstallment.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("400.00"), secondInstallment.getNetExemptedAmount());

        assertEquals(new BigDecimal("0.00"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("1600.00"), academicTreasuryEvent.getNetExemptedAmount());
