...
public class TestRegistrationTuitionRecalculationTestEleven {
    ...
    public void doRecalculation() {
        ...
        settlementNoteBean.getInvoiceEntryBean(firstInstallment).setSettledAmount(new BigDecimal("200.00"));
        ...
        settlementNoteBean.getPaymentEntries()
                .add(new SettlementNoteBean.PaymentEntryBean(new BigDecimal("200.00"), PaymentMethod.findByCode("NU"), null));
