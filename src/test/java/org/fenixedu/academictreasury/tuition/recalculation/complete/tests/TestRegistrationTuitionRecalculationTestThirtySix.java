...
public class TestRegistrationTuitionRecalculationTestThirtySix {
    ...
    public void doRecalculation() {
        ...
        RegistrationTuitionService.startServiceInvocation(registration, executionYear, new LocalDate())
                .applyEnrolledEctsUnits(new BigDecimal("25")) //
                .applyEnrolledCoursesCount(new BigDecimal("5")) //
        ...
        assertEquals(new BigDecimal("263.37"), creditEntry.getAmountWithVat());
        assertEquals(new BigDecimal("36.63"), creditEntry.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("250.00"), secondInstallment.getNetExemptedAmount());

        assertEquals(new BigDecimal("0.00"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("1000.00"), academicTreasuryEvent.getNetExemptedAmount());
