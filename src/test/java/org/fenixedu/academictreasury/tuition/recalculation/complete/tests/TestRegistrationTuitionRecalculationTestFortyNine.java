 ...
 *
 * Creation of 4 instalments at 40 ECTS, €5 per ECTS
...
public class TestRegistrationTuitionRecalculationTestFortyNine {
    ...
    public void doRecalculation() {
        ...
        settlementNoteBean.getInvoiceEntryBean(firstInstallment).setSettledAmount(new BigDecimal("76.74"));
        ...
        settlementNoteBean.getPaymentEntries()
                .add(new SettlementNoteBean.PaymentEntryBean(new BigDecimal("76.74"), PaymentMethod.findByCode("NU"), null));

        SettlementNote.createSettlementNote(settlementNoteBean);

        assertEquals(new BigDecimal("76.74"), firstInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("183.78"), firstInstallment.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("239.48"), secondFirstInstallment.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("0.00"), thirdFirstInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("200.00"), thirdFirstInstallment.getNetExemptedAmount());
        assertEquals(0, thirdFirstInstallment.getSettlementEntriesSet().size());
        ...
        assertEquals(2, secondInstallment.getTreasuryExemptionsSet().size());
        assertEquals(new BigDecimal("0.00"), secondInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("200.00"), secondInstallment.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("52.00"), thirdInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("148.00"), thirdInstallment.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("134.00"), fourInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("66.00"), fourInstallment.getNetExemptedAmount());
