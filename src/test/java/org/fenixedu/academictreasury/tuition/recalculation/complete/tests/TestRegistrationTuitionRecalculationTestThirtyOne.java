 ...
 * 2.ª Moment:
 *
 * Creation of 4 instalments at 31 ECTS, €10 per ECTS
 * Recalculation of the 1st instalment
 *
 * Result:
 *
 * The first installment is maintained and added another debit entry
...
public class TestRegistrationTuitionRecalculationTestThirtyOne {
    ...
    public void doRecalculation() {
        ...
        RegistrationTuitionService.startServiceInvocation(registration, executionYear, new LocalDate())
                .applyEnrolledEctsUnits(new BigDecimal("31")) //
                .applyEnrolledCoursesCount(new BigDecimal("5")) //
        ...
        assertEquals(new BigDecimal("272.15"), academicTreasuryEvent.getAmountWithVatToPay(firstInstallmentProduct));
        assertEquals(new BigDecimal("37.85"), academicTreasuryEvent.getNetExemptedAmount(firstInstallmentProduct));
        ...
        assertEquals(new BigDecimal("8.78"), secondFirstInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("1.22"), secondFirstInstallment.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("272.15"), secondInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("37.85"), secondInstallment.getNetExemptedAmount());

        assertEquals(new BigDecimal("1088.60"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("151.40"), academicTreasuryEvent.getNetExemptedAmount());
