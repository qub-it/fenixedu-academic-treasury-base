...
public class TestsTuitionPaymentPlanRecalculationWithEqualTo30Ects {
    ...
    @Test
    public void recalculationWithEqual30Ects() {
        createTuitionPaymentPlanWithAmountByEcts();
        ...
        assertEquals(academicTreasuryEvent.getAmountWithVatToPay(), new BigDecimal("300.00"));
        ...
        assertEquals(academicTreasuryEvent.getAmountWithVatToPay(), new BigDecimal("1200.00"));
