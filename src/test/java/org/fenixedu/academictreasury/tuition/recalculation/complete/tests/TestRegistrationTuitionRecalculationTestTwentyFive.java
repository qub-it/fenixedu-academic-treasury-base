...
public class TestRegistrationTuitionRecalculationTestTwentyFive {
    ...
    public void doRecalculation() {
        ...
        assertEquals(false, secondFirstInstallment.isEventAnnuled());
        ...
        assertEquals(new BigDecimal("400.00"), secondInstallment.getAmountWithVat());
        ...
        assertEquals(new BigDecimal("350.00"),
                DebitEntry.findActive(academicTreasuryEvent, firstInstallmentProduct).map(DebitEntry::getAvailableNetExemptedAmountForCredit)
                        .reduce(BigDecimal.ZERO, BigDecimal::add));
        ...
        assertEquals(new BigDecimal("400.00"), fourthInstallment.getAmountWithVat());
