...
public class TestsTuitionAllocationPaymentPlanRecalculationWithLessThan30Ects {
    ...
    public void recalculationWithLessThan30Ects() {
        ...
        assertEquals(new BigDecimal("400.00"), academicTreasuryEvent.getAmountWithVatToPay());
