...
public class TestRegistrationTuitionRecalculationTestFortyEight {
    ...
    public void doRecalculation() {
        ...
        assertEquals(new BigDecimal("52.00"), secondInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("248.00"), secondInstallment.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("201.00"), thirdInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("99.00"), thirdInstallment.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("201.00"), fourInstallment.getAmountWithVat());
        assertEquals(new BigDecimal("99.00"), fourInstallment.getNetExemptedAmount());
