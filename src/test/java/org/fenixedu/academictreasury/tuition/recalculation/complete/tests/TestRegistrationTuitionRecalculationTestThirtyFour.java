...
public class TestRegistrationTuitionRecalculationTestThirtyFour {
    ...
    public void doRecalculation() {
        ...
        assertEquals(new BigDecimal("120.00"), academicTreasuryEvent.getNetExemptedAmount(firstInstallmentProduct));
        ...
        assertEquals(new BigDecimal("120.00"), secondFirstInstallment.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("120.00"), secondInstallment.getNetExemptedAmount());

        assertEquals(new BigDecimal("0.00"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("480.00"), academicTreasuryEvent.getNetExemptedAmount());
