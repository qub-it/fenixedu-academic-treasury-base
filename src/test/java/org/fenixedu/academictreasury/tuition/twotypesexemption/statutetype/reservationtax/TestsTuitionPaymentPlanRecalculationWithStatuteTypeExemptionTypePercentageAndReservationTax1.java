...
public class TestsTuitionPaymentPlanRecalculationWithStatuteTypeExemptionTypePercentageAndReservationTax1 {
    ...
    public void tuitionPaymentPlanWithReservationTaxExemption() {
        ...
        assertEquals(new BigDecimal("454.00"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("746.00"), academicTreasuryEvent.getNetExemptedAmount());

        assertEquals(new BigDecimal("0.00"), academicTreasuryEvent.getAmountWithVatToPay(firstInstallmentProduct));
        assertEquals(new BigDecimal("300.00"), academicTreasuryEvent.getNetExemptedAmount(firstInstallmentProduct).setScale(2));

        assertEquals(new BigDecimal("52.00"), academicTreasuryEvent.getAmountWithVatToPay(secondInstallmentProduct));
        assertEquals(new BigDecimal("248.00"), academicTreasuryEvent.getNetExemptedAmount(secondInstallmentProduct));

        assertEquals(new BigDecimal("201.00"), academicTreasuryEvent.getAmountWithVatToPay(thirdInstallmentProduct));
        assertEquals(new BigDecimal("99.00"), academicTreasuryEvent.getNetExemptedAmount(thirdInstallmentProduct));
        
        assertEquals(new BigDecimal("201.00"), academicTreasuryEvent.getAmountWithVatToPay(fourthInstallmentProduct));        
        assertEquals(new BigDecimal("99.00"), academicTreasuryEvent.getNetExemptedAmount(fourthInstallmentProduct));
