...
public class TestsTuitionPaymentPlanRecalculationWithStatuteTypeExemptionTypePercentageAndReservationTaxSameExemptionTypeMoreThan30Ects {
    ...
    public void tuitionPaymentPlanWithReservationTaxExemption() {
        ...
        assertEquals(new BigDecimal("1054.64"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("545.36"), academicTreasuryEvent.getNetExemptedAmount());

        assertEquals(new BigDecimal("1.16"), academicTreasuryEvent.getAmountWithVatToPay(firstInstallmentProduct));
        assertEquals(new BigDecimal("398.84"), academicTreasuryEvent.getNetExemptedAmount(firstInstallmentProduct).setScale(2));

        assertEquals(new BigDecimal("351.16"), academicTreasuryEvent.getAmountWithVatToPay(secondInstallmentProduct));
        assertEquals(new BigDecimal("48.84"), academicTreasuryEvent.getNetExemptedAmount(secondInstallmentProduct));

        assertEquals(new BigDecimal("351.16"), academicTreasuryEvent.getAmountWithVatToPay(thirdInstallmentProduct));
        assertEquals(new BigDecimal("48.84"), academicTreasuryEvent.getNetExemptedAmount(thirdInstallmentProduct));

        assertEquals(new BigDecimal("351.16"), academicTreasuryEvent.getAmountWithVatToPay(fourthInstallmentProduct));
        assertEquals(new BigDecimal("48.84"), academicTreasuryEvent.getNetExemptedAmount(fourthInstallmentProduct));
        ...
        DebitEntry secondDebitEntryOfFirstInstallment = DebitEntry.findActive(academicTreasuryEvent, firstInstallmentProduct)
                .filter(d -> d != firstDebitEntryOfFirstInstallment).iterator().next();

        assertEquals(new BigDecimal("1.16"), secondDebitEntryOfFirstInstallment.getNetAmount());
        assertEquals(new BigDecimal("98.84"), secondDebitEntryOfFirstInstallment.getNetExemptedAmount());
