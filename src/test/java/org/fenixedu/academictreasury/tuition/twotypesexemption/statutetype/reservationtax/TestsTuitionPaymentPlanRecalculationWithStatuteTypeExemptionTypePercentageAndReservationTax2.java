...
public class TestsTuitionPaymentPlanRecalculationWithStatuteTypeExemptionTypePercentageAndReservationTax2 {
    ...
    public void tuitionPaymentPlanWithReservationTaxExemption() {
        ...
        assertEquals(new BigDecimal("167.00"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("133.00"), academicTreasuryEvent.getNetExemptedAmount(firstInstallmentProduct).setScale(2));
        ...
        assertEquals(new BigDecimal("968.00"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("232.00"), academicTreasuryEvent.getNetExemptedAmount());

        assertEquals(new BigDecimal("133.00"), academicTreasuryEvent.getNetExemptedAmount(firstInstallmentProduct).setScale(2));
        assertEquals(new BigDecimal("33.00"), academicTreasuryEvent.getNetExemptedAmount(secondInstallmentProduct));
        assertEquals(new BigDecimal("33.00"), academicTreasuryEvent.getNetExemptedAmount(thirdInstallmentProduct));
        assertEquals(new BigDecimal("33.00"), academicTreasuryEvent.getNetExemptedAmount(fourthInstallmentProduct));

        TreasuryExemptionType usedTreasuryExemptionType1 = TreasuryExemptionType.findByCode("TET2").findFirst().get();
        TreasuryExemptionType usedTreasuryExemptionType2 = TreasuryExemptionType.findByCode("TET4").findFirst().get();
