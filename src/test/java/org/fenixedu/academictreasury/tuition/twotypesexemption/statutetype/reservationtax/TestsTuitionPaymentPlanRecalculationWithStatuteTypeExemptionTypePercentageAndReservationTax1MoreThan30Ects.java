...
public class TestsTuitionPaymentPlanRecalculationWithStatuteTypeExemptionTypePercentageAndReservationTax1MoreThan30Ects {
    ...
    public void tuitionPaymentPlanWithReservationTaxExemption() {
        ...
        assertEquals(new BigDecimal("722.00"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("878.00"), academicTreasuryEvent.getNetExemptedAmount());
        ...
        assertEquals(new BigDecimal("186.00"), academicTreasuryEvent.getAmountWithVatToPay(secondInstallmentProduct));
        assertEquals(new BigDecimal("214.00"), academicTreasuryEvent.getNetExemptedAmount(secondInstallmentProduct));

        assertEquals(new BigDecimal("268.00"), academicTreasuryEvent.getAmountWithVatToPay(thirdInstallmentProduct));
        assertEquals(new BigDecimal("132.00"), academicTreasuryEvent.getNetExemptedAmount(thirdInstallmentProduct));

        assertEquals(new BigDecimal("268.00"), academicTreasuryEvent.getAmountWithVatToPay(fourthInstallmentProduct));
        assertEquals(new BigDecimal("132.00"), academicTreasuryEvent.getNetExemptedAmount(fourthInstallmentProduct));
