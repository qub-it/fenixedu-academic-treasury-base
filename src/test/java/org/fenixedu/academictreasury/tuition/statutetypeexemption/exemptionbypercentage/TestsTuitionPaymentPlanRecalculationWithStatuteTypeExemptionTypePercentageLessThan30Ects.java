...
public class TestsTuitionPaymentPlanRecalculationWithStatuteTypeExemptionTypePercentageLessThan30Ects {
    ...
    public void tuitionPaymentPlanWithReservationTaxExemption() {
        ...
        assertEquals(new BigDecimal("536.00"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("264.00"), academicTreasuryEvent.getNetExemptedAmount());
        
        assertEquals(new BigDecimal("66.00"), academicTreasuryEvent.getNetExemptedAmount(secondInstallmentProduct));
        assertEquals(new BigDecimal("134.00"), academicTreasuryEvent.getAmountWithVatToPay(secondInstallmentProduct));

        assertEquals(new BigDecimal("66.00"), academicTreasuryEvent.getNetExemptedAmount(firstInstallmentProduct));
        assertEquals(new BigDecimal("134.00"), academicTreasuryEvent.getAmountWithVatToPay(firstInstallmentProduct));
