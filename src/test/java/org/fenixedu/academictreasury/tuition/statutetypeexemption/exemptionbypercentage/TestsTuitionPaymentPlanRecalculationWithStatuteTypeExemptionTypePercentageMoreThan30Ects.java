...
public class TestsTuitionPaymentPlanRecalculationWithStatuteTypeExemptionTypePercentageMoreThan30Ects {
    ...
    public void tuitionPaymentPlanWithReservationTaxExemption() {
        ...
        assertEquals(new BigDecimal("1072.00"), academicTreasuryEvent.getAmountWithVatToPay());
        assertEquals(new BigDecimal("528.00"), academicTreasuryEvent.getNetExemptedAmount());
        
        assertEquals(new BigDecimal("132.00"), academicTreasuryEvent.getNetExemptedAmount(secondInstallmentProduct));
        assertEquals(new BigDecimal("268.00"), academicTreasuryEvent.getAmountWithVatToPay(secondInstallmentProduct));

        assertEquals(new BigDecimal("132.00"), academicTreasuryEvent.getNetExemptedAmount(firstInstallmentProduct));
        assertEquals(new BigDecimal("268.00"), academicTreasuryEvent.getAmountWithVatToPay(firstInstallmentProduct));
