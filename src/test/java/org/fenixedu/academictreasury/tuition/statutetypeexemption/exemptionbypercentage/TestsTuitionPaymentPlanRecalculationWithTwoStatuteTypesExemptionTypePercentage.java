...
public class TestsTuitionPaymentPlanRecalculationWithTwoStatuteTypesExemptionTypePercentage {
    ...
    public void tuitionPaymentPlanWithReservationTaxExemption() {
        ...
        assertEquals(new BigDecimal("672.00"), academicTreasuryEvent.getAmountWithVatToPay());
