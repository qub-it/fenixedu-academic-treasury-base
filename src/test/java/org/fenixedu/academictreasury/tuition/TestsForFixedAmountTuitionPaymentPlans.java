...
public class TestsForFixedAmountTuitionPaymentPlans {
    ...
    public static void init() {
        try {
            FenixFramework.getTransactionManager().withTransaction(() -> {
                ...
                createFixedAmountTuitionPaymentPlan();
    ...
    private static TuitionPaymentPlan createFixedAmountTuitionPaymentPlan() {
...

        {
            ...
            academicTariffBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT);
            academicTariffBean.setFixedAmount(new BigDecimal("250"));
    ...
    @Test
    public void fixedAmountTuitionPaymentPlanCreation() {
        createFixedAmountTuitionPaymentPlan();
        ...
        RegistrationTuitionService.startServiceInvocation(registration, executionYear, new LocalDate())
                .withInferedTuitionPaymentPlan().withAllInstallments().withoutInstallmentsRecalculation()
        ...
        assertEquals(academicTreasuryEvent.getAmountWithVatToPay(), new BigDecimal("1000.00"));
    }

    @Test
    public void fixedAmountTuitionPaymentPlanCreationInDuplication() {
        createFixedAmountTuitionPaymentPlan();
        ensureNecessaryAcademicDataIsAvailable();
        ...
        // Invoke twice, should not duplicate tuitions
        RegistrationTuitionService.startServiceInvocation(registration, executionYear, new LocalDate())
                .withInferedTuitionPaymentPlan().withAllInstallments().withoutInstallmentsRecalculation()
                .executeTuitionPaymentPlanCreation();
        ...
        assertEquals(academicTreasuryEvent.getAmountWithVatToPay(), new BigDecimal("1000.00"));
        assertEquals(DebitEntry.findActive(academicTreasuryEvent).count(), 4);
    }
